...
set "VMIME_CONFIG=%VMIME_CONFIG% -DBoost_INCLUDE_DIR:PATH=%SOURCE_DIR%/../boost/"

set "VMIME_CONFIG=%VMIME_CONFIG% -DVMIME_BUILD_SAMPLES:BOOL=OFF"
set "VMIME_CONFIG=%VMIME_CONFIG% -DVMIME_BUILD_DOCUMENTATION:BOOL=OFF"
set "VMIME_CONFIG=%VMIME_CONFIG% -DCPACK_BINARY_NSIS:BOOL=OFF"
